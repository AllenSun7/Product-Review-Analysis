...
def input_xpath():
    #scrapy path
    top_url = "https://www.zillow.com"
    url_detail = "https://www.zillow.com/homes/for_sale/?searchQueryState=%7B%22usersSearchTerm%22%3A%22San+Francisco%2C+CA%22%2C%22mapBounds%22%3A%7B%22west%22%3A-122.56675670282179%2C%22east%22%3A-122.29990129717821%2C%22south%22%3A37.67660776926073%2C%22north%22%3A37.87384358985365%7D%2C%22regionSelection%22%3A%5B%7B%22regionId%22%3A20330%2C%22regionType%22%3A6%7D%5D%2C%22isMapVisible%22%3Atrue%2C%22mapZoom%22%3A12%2C%22filterState%22%3A%7B%7D%2C%22savedSearchEnrollmentId%22%3A%22X1-SS4o5ta0zxhbuu0000000000_4vl2b%22%7D"
...
def parse_data(top_url, id_list_xpath, url_detail, xpath_dic, item_output, next_page_xpath, page=1):
    ...
    test_xpath = "//div[@id='wrapper']/div[6]/div[@id='search-page-react-content']/div[@class='search-page-container map-on-left']/div[@id='search-page-list-container']/div[@id='grid-search-results']/ul[@class='photo-cards photo-cards_wow photo-cards_short']/li[40]/article[@id='zpid_45648816']/div[@class='list-card-info']/a[@class='list-card-link']/address[@class='list-card-addr']/text()"
    test_xpath2 = "//div[@id='wrapper']/div[6]/div[@id='search-page-react-content']/div[@class='search-page-container map-on-left']/div[@id='search-page-list-container']/div[@id='grid-search-results']/ul[@class='photo-cards photo-cards_wow photo-cards_short']/li[1]/article[@id='zpid_2106625070']/div[@class='list-card-info']/div[@class='list-card-heading']/div[@class='list-card-price']/text()"
